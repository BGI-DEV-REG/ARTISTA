...
os.chdir('../data/Figure5_data/Figure5G')
involocito = 'Stage57_telencephalon_rep2_DP8400015649BRD5_1_K0AP4.loom'
inh5ad = 'Batch1_Stage57_telencephalon_rep2_DP8400015649BRD5_1_Annotation_0305.h5ad'
outpath = 'your path'
idname = 'Stage57_telencephalon_rep2_DP8400015649BRD5_1'
num = 0
...
### according to cellid, we extract 4 cell types to analyze
ref = sc.read('Stage57_telencephalon_rep2_DP8400015649BRD5_1.Celltype.0909.h5ad')
ref.obs.index = 'CELL.'+ref.obs['cell_id'].astype(str)
final_match = adata_sel.obs.index & ref.obs.index
...
dyn.pl.cell_wise_vectors(adata_spl_sel3, color=['Annotation_0305'], basis='spatial', show_legend='on data', quiver_length=4, quiver_size=6, pointsize=0.1, show_arrowed_spines=False,color_key=co,figsize=(10, 3))
...
dyn.pl.streamline_plot(adata_spl_sel3, color=['Annotation_0305'], basis='spatial', show_legend='on data',color_key=co,
                       quiver_length=4, quiver_size=5,  show_arrowed_spines=True,background='black',pointsize=0.5,
                       figsize=(3, 3),calpha=1,
                      )
