...
ggsave(paste0(root,'_Pseudotime.pdf'),width = 5,height = 5)

plot_cell_trajectory(Mono.cds, color_by = "Annotation_0306",cell_size = 1)+ggplot2::scale_colour_manual(values = col)
ggsave(paste0(root,'_Annotation_0306.pdf'),width = 5,height = 5)
