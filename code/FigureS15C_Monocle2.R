...
setwd('../data/FigureS15_data/FigureS15_Monocle2')
obj <- readRDS('Batch1_Stage57_telencephalon_rep2_DP8400015649BRD5_1.rds')
Idents(obj) = 'Annotation_0305'
obj = subset(obj,idents=c('DEGC','DNBL4','Immature NPTXEX','NPTXEX'))
root = 'NPTXEX'
...
pData(Mono.cds)$Pseudotime <- max(pData(Mono.cds)$Pseudotime) - pData(Mono.cds)$Pseudotime
...
obj <- readRDS('Batch1_Stage57_telencephalon_rep2_DP8400015649BRD5_1.rds')
Idents(obj) = 'Annotation_0305'
obj = subset(obj,idents=c('DEGC','SFRPEGC','DNBL1','Immature MSN','MSN','Immature CCKIN'))
root = 'MSN'
co = read.csv('Inj_24_Adult_Develop_color_0305.txt',sep = '\t')
celltype =as.data.frame(unique(obj$Annotation_0305))
colnames(celltype) = 'celltype'
...
obj <- readRDS('Batch1_Stage57_telencephalon_rep2_DP8400015649BRD5_1.rds')
Idents(obj) = 'Annotation_0305'
obj = subset(obj,idents=c('DEGC','WNTEGC','DNBL2','Immature MPEX','Immature DPEX'))
root = 'MPEX_DPEX'
co = read.csv('Inj_24_Adult_Develop_color_0305.txt',sep = '\t')
celltype =as.data.frame(unique(obj$Annotation_0305))
colnames(celltype) = 'celltype'
