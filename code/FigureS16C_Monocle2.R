...
obj <- readRDS('Batch1_Injury_control_FP200000239BL_E3.rds')
unique(obj$inj_uninj)
unique(obj$Annotation_0306)
Idents(obj) = 'inj_uninj'
obj = subset(obj,idents='inj')
Idents(obj) = 'Annotation_0306'
obj = subset(obj,idents=c('RIBEGC','SFRPEGC','WNTEGC','TLNBL','NPTXEX'))
obj$Celltype_merge = obj$Annotation_0306
obj$Celltype_merge[which(obj$Celltype_merge=='SFRPEGC')] = 'RIBEGC'
obj$Celltype_merge[which(obj$Celltype_merge=='WNTEGC')] = 'RIBEGC'
root = 'NPTXEX'
