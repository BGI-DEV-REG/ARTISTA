...
setwd('../data/FigureS12_data/FigureS12J_Monocle2')
obj <- readRDS('Batch1_Injury_15DPI_rep4_FP200000266TR_E4.rds')
Idents(obj) = 'Annotation_0306'
obj = subset(obj,idents=c('REAEGC','RIPC1','IMN'))
root = 'NPTXEX'
...
Mono.cds <- reduceDimension(
  Mono.cds,
  max_components = 4,#max_components = 34
  method = 'DDRTree')
...
Mono.cds <- orderCells(Mono.cds, root_state = c('4','5'))
