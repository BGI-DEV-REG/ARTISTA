...
obj <- readRDS('Batch1_Stage44_telencephalon_rep2_FP200000239BL_E4.rds')
unique(obj$Annotation_0305)
Idents(obj) = 'Annotation_0305'
obj = subset(obj,idents=c('DEGC','DNBL1','Immature NPTXEX'))
...
Mono.cds <- orderCells(Mono.cds, root_state = c('5'))
