...
involocito = 'Batch1_Injury_control_FP200000239BL_E3_04DGI.loom'
inh5ad = 'Batch1_Injury_control_FP200000239BL_E3_Annotation_0306.h5ad'
outpath = 'your path'
idname = 'Injury_control_FP200000239BL_E3'
...
#### removed ####
adata_spl_sel2 = adata_spl_sel[(adata_spl_sel.obs['Annotation_0306'] != 'CP') & (adata_spl_sel.obs['Annotation_0306'] != 'VLMC')].copy()
...
dyn.tl.gene_wise_confidence(adata_spl_sel3, group='Annotation_0306', lineage_dict={'RIBEGC': ['NPTXEX']})
...
dyn.tl.confident_cell_velocities(adata_spl_sel3, group='Annotation_0306', lineage_dict={'RIBEGC': ['NPTXEX']},only_transition_genes=True,basis='spatial')
...
#####
dyn.pd.state_graph(adata_spl_sel3, group='Annotation_0306', basis='spatial', method='vf')
dyn.pl.state_graph(adata_spl_sel3,
                   color=['Annotation_0306'],
                   group='Annotation_0306',
                   basis='spatial',
                   show_legend='on data',
                   method='vf')
