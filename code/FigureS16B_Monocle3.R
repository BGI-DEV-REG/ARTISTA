...
data = readRDS('Batch1_Stage54_telencephalon_rep2_DP8400015649BRD6_2.Annotation_0305.rds')

Idents(data) = 'Annotation_0305'
s15_c = c('DEGC','DNBL4','Immature NPTXEX')
...
obj <- RunUMAP(obj, dims = 1:4, verbose = FALSE, min.dist = 0.7)

obj <- FindNeighbors(obj, dims = 1:5, verbose = FALSE)
obj <- FindClusters(obj, verbose = FALSE)
saveRDS(obj,paste0('Batch1_Stage54_telencephalon_rep2_DP8400015649BRD6_2.rds'))
...
saveRDS(cds,paste0('Batch1_Stage54_telencephalon_rep2_DP8400015649BRD6_2_monocle.rds'))
...
write.csv(meta,paste0('Batch1_Stage54_telencephalon_rep2_DP8400015649BRD6_2_monocle.anno.csv'),quote=F)
